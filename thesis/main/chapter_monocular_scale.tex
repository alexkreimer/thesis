...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\linewidth]{flownet_train_loss}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\linewidth]{flownet_prediction_vs_gt}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\linewidth]{flownet_prediction_vs_gt_vs_kf}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\linewidth]{00_motion}
